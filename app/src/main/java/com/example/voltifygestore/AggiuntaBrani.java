...
public class AggiuntaBrani extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bSovrascrivi= (Button)findViewById(R.id.b5);
        ...
        gb=new GestoreBrani(getApplicationContext());
        ...
        bInserisci.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gb.addBranoFile(
                        ...
                        n); //tramite il metodo getSelectedItem prendo la stringa scelta dall'utente e tramite il metodo toString la trasformo in stringa
            }
        });
        ...
        bInvia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                StringBuilder s = gb.leggiBranidafile();// creo una variabile StringBuilder e vi assegno la variabile contenente tutti i brani
                Intent i=new Intent(getApplicationContext(), OutputBrani.class); //creao un intent
        ...
        bSovrascrivi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int n=1;
                //creazione e assegnazione di una varabile di tipo date e assegnazione della stringa inserita dall'utente
